...
- Configuración persistida entre sesiones del navegador
- Todos los componentes muestran los mismos valores
- Propagación inmediata al guardar
- Service Worker restaura estado tras reinicio
- Content Script actualiza idioma sin interrumpir traducción

## Edge Cases

- Service Worker suspendido durante operación
- Múltiples tabs con Content Scripts activos
- Guardar configuración mientras traducción está activa
- Almacenamiento lleno o no disponible
- Popup reabierta tras cerrar sesión de traducción

## Acceptance Criteria

1. Al abrir el Popup, los campos reflejan siempre los valores del almacenamiento persistente
2. Al guardar configuración, todos los componentes se actualizan dentro de un ciclo de evento
3. Al reiniciar el Service Worker, su estado se restaura desde almacenamiento
4. Al cambiar idioma durante traducción activa, el Content Script reanicia sin error
5. No existe estado en memoria que contradiga el almacenamiento persistente
